...
class Events extends Base
{
    ...
    public static function fcAlterTablesOnActivate()
    {
        ...
        self::fcExecuteQueryIfColumnDoesNotExist('oxarticles', 'FCPROMOTIONPLANNERPROMOTIONURL', "ALTER TABLE oxarticles ADD FCPROMOTIONPLANNERPROMOTIONURL text COMMENT 'Promotion Url' NOT NULL AFTER FCPROMOTIONPLANNERACTIVEPROMOTION", $oDb);
        ...
        self::fcExecuteQueryIfColumnDoesNotExist('oxmanufacturers', 'FCPROMOTIONPLANNERPROMOTIONURL', "ALTER TABLE oxmanufacturers ADD FCPROMOTIONPLANNERPROMOTIONURL text COMMENT 'Promotion Url' NOT NULL AFTER FCPROMOTIONPLANNERACTIVEPROMOTION", $oDb);
        ...
        self::fcExecuteQueryIfColumnDoesNotExist('oxcategories', 'FCPROMOTIONPLANNERPROMOTIONURL', "ALTER TABLE oxcategories ADD FCPROMOTIONPLANNERPROMOTIONURL text COMMENT 'Promotion Url' NOT NULL AFTER FCPROMOTIONPLANNERACTIVEPROMOTION", $oDb);
    }
