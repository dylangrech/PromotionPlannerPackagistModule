            ...
            <td class="picEditCol">
                <table>
                    <tr>
                        ...
                        <td>
                            <input type="hidden" name="editval[oxarticles__fcpromotionplanneractivepromotion]" value="0">
                            <input type="checkbox" class="edittext" name="editval[oxarticles__fcpromotionplanneractivepromotion]" value="1" [{if $edit->oxarticles__fcpromotionplanneractivepromotion->value == 1}]checked[{/if}] [{$readonly}]>
