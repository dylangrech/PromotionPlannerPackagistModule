            ...
            <td class="picEditCol">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="edittext">
                            <input step="1" type="text" class="editinput" name="editval[oxmanufacturers__fcpromotionplannerpromotionurl]" value="[{$edit->oxmanufacturers__fcpromotionplannerpromotionurl->value}]" [{$readonly}]>
